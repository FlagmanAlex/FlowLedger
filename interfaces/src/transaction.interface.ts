...
export interface Transaction {
  ...
  exchangeRate?: number;
  /** Комиссия банка в процентах от суммы списания — только для type
   *  'transfer', уменьшает итоговый курс зачисления. В UI вводится суммой в
   *  валюте списания и пересчитывается в процент при сохранении. */
